...
function App() {
  ...
  // here useCurrencyInfo hook return data (in the form of object) after fetching from api
  const currencyInfo = useCurrencyInfo(from);
  // how to access all the keys of the object which is hold by currencyInfo variable we used Object.keys method and passed the object name inside it
  const options = Object.keys(currencyInfo);

  const convert = () => {
    // to convert from with to
